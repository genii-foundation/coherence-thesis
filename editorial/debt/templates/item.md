...
severity: medium
scopes: ["volume-1"]
sources: ["sources/manuscripts/example.md#section"]
...
State the observable conditions required to mark this item resolved.

## History

- 2026-07-09: Recorded.

> When resolving, add a dated history entry and a `## Resolution` section.
