...
sources: ["sources/manuscripts/coherence-thesis-vol1-humanitys-most-viable-future.md", "sources/manuscripts/coherence-thesis-vol3-the-providence-imperative.md", "editorial/voice-cards/volume-1.md", ".agents/skills/coherence-editorial-review/references/editorial-standards.md"]
...
Restore the original heading and bibliographic ampersands, preserve the decisions in the review record, and add a corpus standard that forbids automatic expansion in citations, proper names, quotations, headings, and intentional display matter.
...
Volume I again uses `Seed, Sprout, Stem & Soil`. Volume III again uses ampersands before final authors in the bibliography. The editorial standard now requires contextual judgment for ampersands instead of mechanical expansion.
