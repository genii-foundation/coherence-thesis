...
sources: ["editorial/sources/volumes/volume-01/manuscript.md", "editorial/sources/volumes/volume-03/manuscript.md", "editorial/method/standard.md"]
...
C1 through C3 were already proven when pull request 137 was open. That candidate restored the previously approved contextual ampersand rule in `editorial/method/standard.md`, while C4 remained pending until merge. Pull request 137 has since merged, and the confirmed result is recorded below.
...
- `editorial/evidence/reviews/volumes/volume-01/2026-07-09-wave-one/review.md` records the retained heading and approval rationale.
...
- `editorial/evidence/reviews/volumes/volume-03/2026-07-09-wave-one/sentence-ledger.jsonl` records all twelve restored cases under the approved bibliography convention.
...
- C4: met. `editorial/method/standard.md` now forbids reflexive ampersand expansion and protects proper names, quotations, citation style, headings, titles, labels, and intentional display matter.
...
- `editorial/sources/volumes/volume-01/voice-card.md`, `editorial/evidence/reviews/volumes/volume-01/2026-07-09-wave-one/review.md`, and `editorial/evidence/reviews/volumes/volume-01/2026-07-09-wave-one/structure-ledger.jsonl` preserve the specific display decision while overall voice-card and review-batch approval remains pending.
- `editorial/evidence/reviews/volumes/volume-03/2026-07-09-wave-one/sentence-ledger.jsonl` contains twelve `bibliographic-ampersand-convention-approved` reason codes inside records that remain queries for unrelated evidence work.
- `editorial/method/standard.md` contains the contextual corpus rule beginning `Do not expand ampersands by reflex.`
