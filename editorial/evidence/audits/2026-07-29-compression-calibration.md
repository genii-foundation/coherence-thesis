...
It is the author's instrument. Each entry names a specific loss, shows the text, and states the correct treatment. The entries drive revisions to `editorial/method/standard.md` and to individual voice cards. Nothing here edits a manuscript directly.
...
- Batch: `editorial/evidence/reviews/volumes/volume-04/2026-07-09-production-pass`
