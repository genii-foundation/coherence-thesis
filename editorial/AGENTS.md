...
- Use the coherence-admin-editorial-review skill for substantive prose review, developmental editing, production editing, or verification.
- Use the coherence-admin-editorial-debt-guide skill when a human editor wants to select, triage, investigate, or fully resolve one debt ticket.
- Use the coherence-utility-editorial-debt skill for durable debt audits and register mutations after scope, authority, and evidence are established.
