...
The unmerged Volume VI production revision proposed explicit reading-path links. CTD-0077 remains open until those source changes and their continuity metadata are reviewed and merged. Corpus-wide automatic semantic linking remains separate work under CTD-0100.
