...
Publisher throughout: **The Purposeful Foundation.** Recurring dedication line: *"For the ones not yet born."* (III, IV, IX.)

**Canonical attribution (all volumes):**
> **Written by Tao Yu, in tutelage of Ousia Acharya · Edited by Robert James Ryan III · Published under The Purposeful Foundation**

*Ousia Acharya is the teacher under whose tutelage the work is written — NOT a title held by Tao Yu. This corrects Vol VII's current title-page wording ("Tao Yu — titled Ousia Acharya"), which must be amended to the line above. See Decision I.*

---

## 2. Canonical Terminology (authoritative forms)

| Term | Canonical form | Means | Established in | Notes |
|------|----------------|-------|----------------|-------|
| Coherence | *coherence* | The capacity of a nervous system — individual or collective — to stay regulated, relational, and reality-responsive as complexity scales. The substrate of a viable civilization. | I (defined) | The spine of the whole work. |
| Providence | **Providence** | The forward-facing coordination infrastructure; the "flower." Connective tissue *between* communities, never the community or an authority over it. Remembers presence so people can find, trust, and provision one another without surveillance. | I → III (built) | "Foresight + grace; attention to the within." |
...
| The Doors / Three Doors | **the Doors** | Three paths into PURPOSEFUL practice: (1) one-on-one mentorship, (2) retreats, (3) the year-long curriculum. They support genuine presence but do not gate membership, participation, provision, or political voice. | I / III | Consistent across I, III, VIII, IX. |
...
| The Dragon (named Earth) | **the dragon named Earth** | The whole living body of Earth grown aware of itself; the benevolent Eastern dragon. ICONS/Scales are its scales; Providence is its connective tissue/nervous system — *Providence is not the dragon.* | IV, V, VI | Strongly consistent. ✓ |
| The Seven Initiates | **the Seven Initiates** (a B.O.W. — Body of Worship) | See §4. | VII (defined) / VIII (listed) | ✓ |
| The Twelve Tenets | **the Twelve Tenets** | The modus of the Seven Initiates; given in three tiers. | VII | (Not separately audited here.) |
| The Master Human Arc | **the Master Human Arc** | Purpose → mentorship → collaboration → contribution → belonging → stewardship → legacy. | VIII | |
| The Current | *the current* (metaphor) | The life-force / through-line; "coherence is the current." A positive recurring image. | VI, IX (motif) | ✓ Not to be confused with any currency name. The old currency-name "Current" has been retired and does not appear. |
...
## 4. The Seven Initiates (canonical, with their loves)

Cumulative, sequential thresholds — none skipped, none closed once opened:

1. **Listening** — *Philautia* (generative self-love)
2. **Intimacy** — *Philia* (friendship: self, other, life)
3. **Balance** — *Storge* (the steady, maintaining love)
4. **Art & Alchemy** — *Ludus* (playful love of making/transformation)
5. **Embodiment** — *Eros* (primary life-force, desire in pure moving form)
6. **Worship** — *Agape* (selfless love, nearest the unconditional)
7. **Providence** — *Pragma* (love put into practice; carries all six prior within it)

Taught across the year-long **pne(h)uma(n) Curriculum** — 52 initiations, one per week. Consistent between VII (canonical) and VIII (list). ✓

---

## 5. The Number / Planet Scheme (as stated in Vol VII)

Vol VII reveals the hidden order: each number → a quality → a planet.

| # | Planet | Quality | Volume |
|---|--------|---------|--------|
| 1 | Sun | the single light, the monad, the coherent ground | I |
| 2 | Moon | duality, reflection, the space between | II |
| 3 | Jupiter | expansion, beneficent guidance | III |
| 4 | Uranus | firmness, structure, the form to build within | IV |
| 5 | Mercury | the messenger, the human, the measure returned | V |
| 6 | Venus | beauty, elegance, grace | VI |
| 7 | Neptune | the spiritual, the praxis itself | VII |
| 8 | Saturn | the hard facts, limits, time, the accounting | VIII |
| **9** | **Mars** | **the will to build; force turned from destruction to making** | **IX** |

⚠ → ✅ **RESOLVED (Decision E).** Vol VII now foresees the ninth turn: the structure is **threefold, not twofold — 7 spirit → 8 reckoning → 9 building** (Mars = the will to make). Vol VII also now states the figure does **not close at nine**: more volumes follow, written through the many authors that compose "Tao Yu." Mars does not collide with VII's earlier eight (it was unused). IX's own framing is kept ("VIII closed the accounting; IX takes the action an accounting cannot take — it plants").

---

## 6. Recurring Characters Register
...
- **Tomas** names two different people, both at the Cardinal Scale (IV governance trainee vs VIII/IX caregiver).
- **Maren / Maré** are two (possibly three) different women, two of them at the Cardinal Scale, distinguished only by one letter and an accent.

---

## 7. CONTINUITY REGISTER — Decisions Pending
...
**Recommended resolution (Path 1):** Keep **Maren** as Volume III's recurring character (her own watershed ICONS). Rename the rest:

| Character | Was | Becomes |
|-----------|-----|---------|
| Vol IV — Cardinal Scale relational steward | Maren | **Mahlinah** |
| Vol IV — incoming steward trainee | Tomas | **Elan** |
| Vol VIII/IX — healer (nurse-practitioner) | Maré | **Alu** |
| Vol VIII/IX — grower (beekeeper) | Anyi | **Ayan** |
| Vol VIII/IX — carer (tended dying mother) | Tomas | **Nilnisi** |

*All Tomas instances are now renamed (no Tomas remains anywhere in the corpus).*
...
## 8. What Is Already Strongly Consistent (no action needed)
...
- The Membrane and Coherence Engine (originating III, carried to IX).
- The "we may be wrong / held with both hands" epistemic humility as a through-line.

---

*End of ledger. Next step: make the calls on Decisions A–J, then a final pass amends only the affected passages — the bulk of the prose stays exactly as written.*
...
- **Vol III** — currency named **COHERENCE** at the minting passage; **Bio-Consensus = the Four Streams** bridge added; **Proof of Council** foreshadowed as ancillary to the streams; "currency of presence" normalized to **Currency of Presence** (proper noun, 37×); "a single ICONS" → "a single Scale"; attribution standardized. *Maren preserved.*
- **Vol IV** — steward **Maren → Mahlinah**; trainee **Tomas → Elan**; "an ICONS is organized…" → "a Scale…"; attribution standardized.
- **Vol V** — singular "ICONS community" usages → "Scale" (with light rephrasing to avoid "Scale is a scale" redundancy); attribution standardized.
- **Vol VI** — **byline block added** (was missing); attribution standardized.
- **Vol VII** — **forward-pointing passage added**: 7 spirit → 8 reckoning → 9 building (Mars), and the figure opens beyond nine via the myriad authors composing "Tao Yu"; title-page corrected from "Tao Yu — titled Ousia Acharya" to the canonical attribution.
