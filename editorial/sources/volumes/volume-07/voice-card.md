...
- Central thesis: coherent civilization requires practices that cultivate attention, relation, embodied awareness, and responsibility, but no practice may outrank consent, evidence, or equal human standing.
- Intended reader: a spiritually curious general reader willing to test mystical language without mistaking it for proof.
- Relationship to the reader: invitational, fallible, and non-coercive. The narrator may offer a path but may not define the reader's readiness, identity, or inner state.
- Narrative stance: first person plural for the project's intentions, direct definition for the practices, and guarded speculative language for metaphysical or scientific claims.
- Default intervention level: Level 2, with Level 3 compression for repeated formulaic summaries and Level 3 safeguarding changes where mentor authority or program claims exceeded the evidence.
...
- Read-aloud qualities to preserve: the threshold language around genius, the musical account of resonance, the touch exercise, the slow meal at retreat, and the Coda's spare lines.

## Language

- Canonical terms: coherence; presence; presencing; Providence; PURPOSEFUL; Body of Worship; B.O.W. Councils; the Seven Initiates; the Twelve Tenets; the Four Windows of Perception; pne(h)uma(n) Curriculum; Coherent Resonance.
...
- Exemplar opening anchors: "Presence is a state; presencing is an act"; "Genius is a Latin word, and to the Romans it did not mean a clever individual"; "Listening is the gateway"; "Coherent Resonance is the quality of being that emanates"; "Training has three movements"; "To see the mechanism plainly, take a single sense, touch"; "A retreat is structured as a passage, not a program"; "We began by recalling what each volume has done"
