...
And it is **exclusionary.** A low score locks you out of life: travel, housing, work, food. This is the line that must never be crossed. Providence cannot yet promise a universal material floor, because no institution or funding base exists to carry one. During the capacity-limited beginning, people who freely join and participate in a consociation build a shared guarantee of food, shelter, care, dignity, and belonging. That guarantee survives illness, disability, dependence, caregiving, crisis, technological exclusion, and temporary incapacity. It ends when a person freely withdraws from participation, not when a body fails to regulate or a record fails to rise. The intended destination remains a floor open to every person. Within every stage, **the currency may open doors to greater trust, but it may never close the door to provision already promised.** The currency can raise a ceiling of bounded stewardship. It can never decide who is worthy of a floor.
