...
- Read-aloud qualities to preserve: the shift from map to construction; the sentence about the nest bearing weight; the long clock and ordinary provision; Mahlinah and Elan's awkward handoff; the donor's good faith and incompatible terms; the dragon as image under explicit limits.
...
- Images that must not be explained away: the nest declared load-bearing only after someone stands in it; the long clock that still has to feed people; Elan learning beside Mahlinah; the watershed thresholds and automatic reversion; the donor declining the counteroffer; the first Scale awaiting ground; Scales catching different light along the dragon.
...
- Exemplar passages that define the voice: the new opening status statement; the four kinds of building question; the direct-trust and nested Scale distinction; the funding portfolio and refusal conditions; the identity and attestation limits; the first application's prohibitions; the reciprocal invitation; Tuesday afternoon; the donor sequence; the dragon's explicit limits.
