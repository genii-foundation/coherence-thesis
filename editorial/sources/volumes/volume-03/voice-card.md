...
- Central thesis: civilization needs trustworthy ways to coordinate wisdom as technical capability grows. Providence is one provisional architecture built from human matching, shared practice, participant sovereignty, and a speculative Currency of Presence.
- Intended reader: a serious general reader willing to follow institutional, technical, economic, and physiological arguments without treating fluency as evidence.
- Relationship to the reader: candid, invitational, and adversarial in the best sense. The narrator asks for scrutiny, exposes failure modes, and does not conscript agreement.
- Narrative stance: first person plural for the builders' commitments, third person analysis for mechanisms and risks, and close narrative attention in Maren's design fiction.
- Default intervention level: Level 2. Level 3 is appropriate for repeated conclusions, scientific overclaim, pitch language, governance contradictions, and section scaffolding that hides the argument.
...
- Read-aloud qualities to preserve: the wind and weight of the nest; the pace of Maren's intake; the quieter sentence after a technical qualification; the constitutional bright lines; the final questions.

## Language

- Canonical terms: coherence; Providence; PURPOSEFUL; the Currency of Presence; COHERENCE; Bio-Consensus; Proof of Council; the Four Streams; the Coherence Engine; the Reflective Mirror; the Membrane; the three Doors; ICONS; Scale; the Cardinal Scale.
...
- Quotation provenance: every quoted string above is verbatim in the named baseline, in the corpus rendering convention, and stands in the current manuscript.
- Post-baseline doctrine control: the bright line beginning `It cannot use a coherence measure to withdraw necessities already guaranteed` carries the 2026-08-12 CTD-0005 ruling. It is not a baseline quotation. It must preserve equal vote weight and the open CTD-0006 decision on biometric-derived stewardship evidence.
...
- Open author decisions: the exact institutional form, funding, goods, reserves, jurisdiction, scarcity rules, and remedies for the staged material floor; whether biometric-derived evidence may affect particular stewardship eligibility; whether COHERENCE records relation or is identical with it; and which epigraphs are quotations rather than adaptations. The 2026-08-12 CTD-0005 ruling forbids coherence evidence from changing voting rights or creating superior political standing.
