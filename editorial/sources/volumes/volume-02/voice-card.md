...
- Central thesis: intelligence magnifies the relational conditions that wield it. Humane technology therefore depends on human and civilizational coherence, not technical capability alone.
- Intended reader: an intellectually serious reader working near technology, governance, culture, ecological regeneration, or inner development who is willing to follow an argument from physiology to planetary coordination.
- Relationship to the reader: candid and invitational. The book may offer language and orientation, but it must not claim access to the reader's private experience or demand agreement as proof of attention.
- Narrative stance: first person editorial witness joined to philosophical diagnosis. The argument moves from nervous systems and relationships to institutions, then to a deliberately provisional project architecture.
- Default intervention level: Level 2. Use Level 3 only where repetition conceals the argument, a paragraph's sequence fails, or a heading no longer names the section it governs.
...
- Read-aloud qualities to preserve: breath, gravity, cumulative movement, and the contrast between patient explanation and sudden clarity.

## Language

- Canonical terms: coherence, Providence, PURPOSEFUL, Currency of Presence, COHERENCE, ICONS, substrate, relational field, nervous-system regulation, extraction, regeneration, alignment, right relationship.
...
- Signature metaphors: substrate, threshold, nest, field, architecture, circulation, and intelligence as a power that must be wielded.
- Recurring images and motifs: nervous systems beneath institutions, fragments finding one another, ecological circulation, lunar rhythm, and civilizational transition.
- Protected structural devices: title-page ritual, dedications, self-epigraphs, `. : .` dividers, parts and numbered chapters, the Reference Model, and explicit project-state disclosures.
- Images that must not be explained away: the nest, the threshold, the field, and the distinction between intelligence as capability and wielding as development.
- Mixed or exhausted metaphors to watch: substrate, metabolism, architecture, field, and circulation can each become vague when several occupy one sentence. Choose the image that performs the actual reasoning.
...
- Open author decisions: determine whether Volume I self-epigraphs are verbatim quotations or adaptations; decide whether the strongest formulations of civilizational urgency reflect the desired final degree of certainty; define the institutions and resources that can make the staged material floor real. The 2026-08-12 CTD-0005 ruling forbids coherence evidence from controlling promised provision or vote weight.
