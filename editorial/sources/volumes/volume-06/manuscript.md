...
A blueprint is not a prophecy. This one will be wrong in places. But even its errors are an offering, because the surest way to call a better world into being is to set down a clear enough version of one that others can see precisely where it fails, and build past it. That is the hope of these pages: not that you adopt the blueprint, but that it carries you forward. You may yet see the way more lucidly than we have managed, and build what we could only point toward.
