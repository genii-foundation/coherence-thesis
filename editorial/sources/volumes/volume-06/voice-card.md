...
- Narrative stance: lyrical first person plural for the shared proposal; analytical third person where claims need bounds; direct address only as an explicit invitation.
- Default intervention level: Level 2 with genre-sensitive Level 3 compression of repeated codas, performed intimacy, malformed display matter, and unsupported scientific or metaphysical certainty.
...
- Read-aloud qualities to preserve: the gradual widening from line to minute to chamber; the loom and thread; the small nest holding a large life; the final quiet naming of awareness.

## Language

- Canonical terms: coherence; Purposeful; Providence; Scale; ICONS; the Currency of Presence; COHERENCE; the dragon named Earth; the Seven Initiates; B.O.W.; Body of Worship; Art & Alchemy.
- Terms with volume-specific meanings: current is the metaphor for coherence; pathway is Purposeful; loom is Providence; nest is a complete account held at a chosen scale; dragon is a planetary image and open proposition, not evidence of one literal mind.
- Signature diction: nest, current, between, gift, pathway, seeing, loom, thread, Scale, dragon, waking, remembering, room, and ground.
- Diction that belongs to other volumes and should not migrate here: extensive implementation inventories, long evidentiary catalogs, bureaucratic governance language, and claims of scientific completion.
- Recurrent phrases that are intentional: the smallest nest; begin again; the choice is yours; current, pathway, loom, currency.
- Recurrent phrases that should be reduced: that is why; you have felt; you were made; you remember; the whole of it; for the first time; actually; truly; deepest.

## Images and structure

- Signature metaphors: nested knowledge; coherence as current; Providence as loom; community as nest; sovereign communities as scales; planetary relation as dragon.
- Recurring images and motifs: seed and soil; thread and weaving; a room containing a beginning; dawn arriving through quiet kindling; awareness becoming answerable to life.
- Protected structural devices: two parts; the line, minute, unfolded account, and eleven chambers; the Part Two path back through Volumes I to V; the envoi.
- Images that must not be explained away: a nest holding the whole in the least space; the loom making encounters less accidental; the dragon as many scales held in one living image; the invitation to begin again.
- Mixed or exhausted metaphors to watch: current, grain, nest, loom, currency, nervous system, body, and dragon can crowd one another. Give each section one primary image.
...
- Exemplar opening anchors: "Much human capacity never finds the people"; "Here is the whole of it, small enough to carry"; "Beneath the series runs one concept: coherence"; "If coherence became something a community honored"; "The design needs a community large enough"; "We do not stand outside nature"; "The envoi imagines a future in which the species turns again"
