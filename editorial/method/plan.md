...
The complete standard lives in `editorial/method/standard.md`. Five principles govern the whole program.
...
- A reusable review record in `editorial/method/templates/review-record.md`
- The sentence ledger contract in `editorial/method/schemas/sentence-ledger.md`
- The structure ledger contract in `editorial/method/schemas/structure-ledger.md`
- The review manifest contract in `editorial/method/schemas/review-manifest.md`
- A reusable volume voice card in `editorial/method/templates/voice-card.md`
