...
Use `coherence-admin-editorial-debt-guide` as the human front door. This skill owns durable register operations after the guide establishes scope, authority, and evidence.
