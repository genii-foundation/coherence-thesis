...
export function formatAudioPublicationFailure(
  ...
  return [
    ...
    `  1. Generate the exact sections: ${sectionIds.join(",")}`,
    "  2. Publish new immutable audio and timing sidecars under a reviewed checkpoint.",
    "  3. Promote that checkpoint into publishing/audio/manifest.json.",
